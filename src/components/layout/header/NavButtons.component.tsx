...
export const NavButtons: React.FC<NavButtonsProps> = ({ requests, setIsRequestPanelOpen }) => (
  <div className="hidden md:flex items-center space-x-4 md:space-x-6">
    <Button className="py-5">
      <CirclePlus className="mr-2" /> New Idea
    </Button>
    <Button variant="outline" className="py-5">View Ideas</Button>
    <Button variant="outline" className="py-5">Event Calendar</Button>
